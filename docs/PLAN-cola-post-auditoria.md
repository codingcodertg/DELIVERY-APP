...
| 3 | `guard-rutas-conectado` | G-29 `updateSession` escrito y sin llamar; cierra G-2 (`/login` sin `next`) | Conectar en `src/middleware.ts`, con prueba de las rutas públicas y del `next` | en marcha |
