...
import { saveSubscription, sendTestPush, deleteSubscription } from "@/app/clock-in/actions/push";
...
export default function EnableNotifications({ lang }: { lang: Lang }) {
  ...
  async function enable() {
    ...
    setMsg(null);
    try {
      const reg = await navigator.serviceWorker.register("/clockin-sw.js", { scope: "/clock-in/" });
