    ...
    <main className="flex-1 w-full max-w-md mx-auto flex flex-col p-5 gap-5">
      ...
      {name && tourRole !== "owner" && (
        <div className="grid grid-cols-3 gap-2">
          {[
            { href: "/clock-in/my-schedule", icon: "📅", label: tr.mySchedule },
            { href: "/clock-in/notes", icon: "📝", label: tr.dailyNotes },
            { href: "/clock-in/me", icon: "📊", label: tr.myAccountability },
          ].map((tile) => (
            <Link
              key={tile.href}
              href={tile.href}
        ...
        <section className="rounded-2xl border border-amber-300 bg-amber-50/70 dark:bg-amber-950/20 p-4">
          ...
          <ul className="mt-2 flex flex-col gap-1.5">
            {pending!.timesheets > 0 && (
              <li>
                <Link href="/clock-in/reports" className={todoLink}>
            ...
            {pending!.timeoff > 0 && (
              <li>
                <Link href="/clock-in/time-off" className={todoLink}>
            ...
            {pending!.exceptions > 0 && (
              <li>
                <Link href="/clock-in/exceptions" className={todoLink}>
