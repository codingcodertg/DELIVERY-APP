...
export default async function DashboardPage() {
  ...
  return (
    <main className="flex-1 w-full max-w-3xl mx-auto p-5 flex flex-col gap-6">
      ...
      <a href="/clock-in/coverage" className="rounded-2xl border border-emerald-200 dark:border-emerald-900 bg-emerald-50/40 dark:bg-emerald-950/20 p-5 text-center hover:bg-emerald-50 dark:hover:bg-emerald-950/40 transition-colors">
