 ...
 *
 * **Desde D-NEXT (2026-09-26, por la tarde) la atrasada ya no SALE de la lista normal**: está en las
...
/**
 * ¿Va esta orden a «Outdated»? (Hasta D-NEXT, eso la sacaba de la lista normal; ya no: va a las dos.)
 *
 ...
 * suelo se quitó; la de ayer también salía de «Todas» (hasta D-NEXT: ahora se queda en las dos).
 *
