...
/**
 * Lo que entra en la pestaña «Factura pendiente» (D-NEXT). El dueño: «in the invoice pending just to show invoice not po».
...
/**
 * `primero`: las tiendas de quien mira, en orden —la suya y luego las que además ve (D-NEXT)—. Sus grupos salen ANTES que los
