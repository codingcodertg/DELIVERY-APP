 ...
 *   otro: `null`.
 * **Reemplazado en parte por D-337:** ya no hay selector en la orden ni marca en la cuenta. El dueño: «en cuenta ahí se
...
/**
 * La opción fija del campo Cuenta para un cliente de paso (D-337). Es vocabulario de la app, no un dato de nadie: se
