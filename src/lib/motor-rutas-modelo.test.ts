...
describe("builder o mostrador", () => {
  ...
  it("por defecto (D-NEXT): Mostrador SOLO con la opción fija de mostrador; Builder todo lo demás, también sin cuenta", () => {
...
describe("la red: no se manda customer_type a una base que todavía no lo tiene", () => {
  ...
  it("el formulario guarda con el parche; ya NO hay selector: la cuenta decide el tipo, y lo cambia con ella (D-NEXT)", () => {
