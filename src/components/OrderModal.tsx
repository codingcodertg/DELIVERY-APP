...
export function OrderModal({
  ...
  /**
   * La ficha lee la orden VIVA de la lista, no la foto que le pasó quien la abrió (D-364).
   *
  ...
  // «Agregar material» (D-339): la factura nueva y los pallets nuevos, del vendedor dueño de la
  ...
  return (
    ...
    <div className="overlay"
      ...
      <div className="modal">
                ...
                <div className="card" style={{ padding: 14 }}>
                  ...
                  <div className="detail-grid">
                    {([
                      ...
                      // Las facturas AÑADIDAS después (D-339), solo cuando hay alguna: la orden lleva más
        ...
        {/* Se salta en tienda-a-tienda, como dice el comentario de arriba — y ahora también cuando la
        ...
        {editing && paso === "inicial" && (
          <>
            ...
            {/* El punto exacto, soltando un pin. «Buscar dirección en el mapa» se quitó (D-337): la dirección se ubica sola al
          ...
          <>
            ...
            <div className="grid g3">
              <AccountCombo
                val={d.account}
                on={(elegida) => {
                  // «Venta al mostrador» se guarda SIEMPRE con la misma cadena, se teclee como se teclee (D-337).
            ...
            {isIntraStore ? (
              ...
              <div className="grid g2">
                ...
                <Sel
                  ...
                  opts={opcionesDeDestino(d, settings.stores, reglaDelTipo)}
 ...
 *  se escribe; qué casa lo decide `ordenConEsaFactura` (D-337). */
...
function AccountCombo({ val, on, options, fija, disabled, placeholder, t }: {
  ...
  /** Una opción que está SIEMPRE a mano, fuera de la lista: «Venta al mostrador» (D-337). */
