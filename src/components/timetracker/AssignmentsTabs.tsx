...
/**
 * Asignaciones, en DOS secciones (D-NEXT): las tarifas por proyecto y el horario semanal.
 *
 ...
 * salte ningún error. Si algún día se te ocurre pasar una lista a la otra sección, lee D-NEXT
 * primero.
 *
