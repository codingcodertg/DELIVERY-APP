...
export interface MapPoint {
  ...
  dimmed?: boolean;
  /**
   * Desplazamiento en PÍXELES sobre el punto real, para abrir en abanico las marcas que comparten coordenada (D-367).
...
export function LeafletMap({
  ...
  // Desde D-365 ya no van encima del pin de una orden: `Z_CASITA_DESPACHO`. Con la recogida en la tienda las dos marcas
